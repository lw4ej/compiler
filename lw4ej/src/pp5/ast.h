...
class Node 
{
  ...
  public:
	...
	SymbolTable* getTable()           { return nodeTable; }
	char *getname()                   { return NULL; }
	Decl *Lookup(Identifier *id, bool local);
	virtual SymbolTable* ConsTable()  { return NULL; }
	virtual void Check(){}
	
	CodeGenerator* GetGenerator()     { return codegen; }
	virtual void Emit(){}
};
